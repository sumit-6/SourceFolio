    ...
    return (
        ...
        { inputList.map((x, index) => {
            return (
                ...
                <InputBox field="Programming Language" type="text" id={`skillName_${index}`} name="skillName" placeholder="Enter skill name" value={x.skillName} handleChange={handleinputchange} index={index}></InputBox>
                <CustomSelect field="Skill Level" index={index} value={x.skillLevel} id={`skillLevel_${index}`} name="skillLevel" array={skillLevelOptions} handleChange={handleinputchange}></CustomSelect>
