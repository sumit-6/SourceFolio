...
const AboutMe = (props) => {
    ...
    return (
        <div className="bg-gradient-to-r from-slate-300 to-slate-500 p-4 mt-6" style={{display: props.isSelected?"":"none"}}>
            ...
            <TextArea field="Description" id="description" name="description" value={inputObj.description} placeholder="Enter your description of your projessional life...
For Example: 'I am a Full Stack Developer and I can create web pages with UI/UX interfaces. Apart from that I love doing DSA and problem-solving.'" handleChange={handleinputchange}></TextArea>
        </div>
    );
};
